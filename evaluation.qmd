...
- Be delayed (by a maximum of 24 hours) on more than one assignment.
...
In general, submitting a satisfactory assignment means that you follow the assignment instructions and complete the list of questions or tasks. If you do not satisfactorily complete an assignment (as in, you do not complete the assignment requirements but still submit the assignment), **you will not automatically "fail" the assignment**. Instead, I will contact you to let you know **which part of the assignment was unsatisfactory** and **ask you to resubmit the assignment** within an appropriate time frame. The goal here is not to punish you, but to give you an opportunity to learn from your mistakes without fear of failure/lost grades. As a general rule, I do not advice exploiting this rule since you will have assignments due nearly every week and the workload can easily snowball beyond control.
